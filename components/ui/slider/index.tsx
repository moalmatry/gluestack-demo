...
const sliderThumbStyle = tva({
  base: "bg-blue-500 absolute rounded-full data-[focus=true]:bg-blue-600 data-[active=true]:bg-blue-600 data-[hover=true]:bg-blue-600 data-[disabled=true]:bg-blue-500 web:cursor-pointer web:data-[active=true]:outline web:data-[active=true]:outline-4 web:data-[active=true]:outline-blue-400 shadow-hard-1",
...
const sliderFilledTrackStyle = tva({
  base: "bg-blue-500 data-[focus=true]:bg-blue-600 data-[active=true]:bg-blue-600 data-[hover=true]:bg-blue-600",
  parentVariants: {
    orientation: {
      horizontal: "h-full",
      vertical: "w-full",
